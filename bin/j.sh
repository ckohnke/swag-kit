...
# Where is the swag toolkit? (Where is your build.xml?)
export SWAG_HOME=$HOME/workspace/swag-kit/
...
export CLASSPATH=\
$SWAG_HOME/build/libs/no_swag.jar:\
$SWAG_HOME/libs/commons-codec-1.9.jar:\
.
